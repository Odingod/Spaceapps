...
$.fn.formRenderer = function(conf){
	...
	renderedFields.push([
		'<div class="form-group submits">',
			'<div class="col-xs-6">',
				'<input type="button" class="btn btn-default btn-block" id="nappula" value="Lähetä" onclick="sendForm()">',
			'</div>',
			'<div class="col-xs-6">',
				'<input type="reset" class="btn btn-default btn-block" id="nappula2" value="Reset" onclick="getImageBase64()">',
			'<div>',
		'</div>',
		'</fieldset>'
	].join(''));
